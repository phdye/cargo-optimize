...
mod performance_optimization {
    ...
    fn test_detection_speed() {
        ...
        // Should complete in under 200ms (allowing for system variability)
        assert!(duration < Duration::from_millis(200), 
                "Detection took {:?}, should be < 200ms", duration);
    }

    #[test]
    fn test_config_generation_speed() {
        // Config generation should be instant
        ...
        // 10 detections should take < 1000ms total
