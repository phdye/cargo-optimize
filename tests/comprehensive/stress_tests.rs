...
use cargo_optimize::{analyzer::*, detector::*, optimizer::*, Config, OptimizationLevel};
...
"#;
    ...
    let member_list: Vec<String> = (0..50).map(|i| format!("\"crate_{}\"", i)).collect();
